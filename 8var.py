...
while len(inp)>0:
    ...
    if inp.startswith("int"):
        ...
        if inp[0]=="n":
            lastInt=newInt
            if intFin==1:
                sys.exit("ERROR: Out of empty variables of type int.")
            if newInt<=7:
                inp=inp[1:]
                intVar=""
                if inp[0]=="-":
        ...
        if inp[0]=="n":
            lastBool=newBool
            if boolFin==1:
                sys.exit("ERROR: Out of empty variables of type bool.")
            if newBool<=7:
                inp=inp[1:]
                if inp[0] in "1t0f+-":
                    if inp[0] in "1t+":
        ...
        if inp[0]=="n":
            lastStr=newStr
            if strFin==1:
                sys.exit("ERROR: Out of variables of type str.")
            if newStr<=7:
                inp=inp[1:]
                strVar=""
    ...
    if inp.startswith("float"):
        inp=inp[5:]
        if inp[0]=="n":
            lastFloat=newFloat
            if floatFin==1:
                sys.exit("ERROR: Out of variables of type float.")
            if newFloat<=7:
                inp=inp[1:]
                floatVar=""
                if inp[0]=="+":
